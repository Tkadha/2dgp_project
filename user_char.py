...
class StateMachine:
    def __init__(self, user):
        ...
        self.cur_state = Idle
        self.transitions = {
            Idle: {right_down: Run, left_down: Run, left_up: Run, right_up: Run, above_down: Run, above_up: Run, under_down: Run, under_up: Run},
            Run: {right_down: Idle, left_down: Idle, right_up: Idle, left_up: Idle, above_down: Idle, above_up: Idle, under_down: Idle, under_up: Idle}
        }
